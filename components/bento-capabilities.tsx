          ...
          <div className="flex flex-col justify-between rounded-xl border border-[#E7E5E4] bg-white p-7 md:col-span-7 sm:p-9 shadow-xs">
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#57534E]">
                A clean, bespoke website built to make your business look like the clear leader in your town. Fast on every phone, easy for customers to navigate, and built to turn visitors into phone calls.
              </p>
            </div>
            ...
            <div className="mt-8 rounded-lg border border-[#E7E5E4] bg-[#F9F9F7] p-5">
              ...
              <div className="mt-3 grid grid-cols-3 gap-3 text-center">
                <div className="rounded border border-[#E7E5E4] bg-white p-3">
                  <div className="font-mono text-xs text-[#78716C]">Page Load</div>
                  <div className="mt-1 font-mono text-sm font-semibold text-[#111827]">&lt; 1 Second</div>
                </div>
                <div className="rounded border border-[#E7E5E4] bg-white p-3">
                  <div className="font-mono text-xs text-[#78716C]">Mobile</div>
                  <div className="mt-1 font-mono text-sm font-semibold text-[#111827]">100% Ready</div>
                </div>
                <div className="rounded border border-[#E7E5E4] bg-white p-3">
                  <div className="font-mono text-xs text-[#78716C]">Google SEO</div>
                  <div className="mt-1 font-mono text-sm font-semibold text-[#111827]">Connected</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between rounded-xl border border-[#E7E5E4] bg-white p-7 md:col-span-7 sm:p-9 shadow-xs">
            <div>
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xs text-[#78716C]">Win Back Quotes</span>
              </div>
              <h3 className="mt-6 font-serif text-2xl text-[#111827]">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-lg border border-[#E7E5E4] bg-[#F9F9F7] p-5">
              <div>
                <div className="font-mono text-xs text-[#78716C]">RESULTS FROM FOLLOW-UP SPRINT</div>
