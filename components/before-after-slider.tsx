...
export function BeforeAfterSlider() {
  ...
  return (
    <div
      ...
      className="relative mx-auto mt-10 aspect-[21/9] w-full max-w-5xl overflow-hidden rounded-xl border border-[#E7E5E4] bg-[#E7E5E4] select-none touch-none cursor-ew-resize shadow-md focus-visible:ring-2 focus-visible:ring-[#065F46] focus-visible:outline-none"
    ...
    >
      ...
      <img
        ...
        alt="After: Modern 2026 Alizane Labs Website"
        draggable={false}
      ...
      >
        ...
        <img
          ...
          alt="Before: Typical Generic Local Business Website"
          draggable={false}
          className="pointer-events-none absolute inset-0 h-full w-full object-cover object-top select-none"
        />
      </div>
      ...
      {/* Floating Badges */}
      <span className="pointer-events-none absolute top-4 left-4 rounded-full bg-[#111827]/80 px-3 py-1 font-mono text-[11px] uppercase tracking-wider text-white shadow-xs backdrop-blur-xs">
        Before: Generic Site
      </span>
      <span className="pointer-events-none absolute top-4 right-4 rounded-full bg-[#065F46]/90 px-3 py-1 font-mono text-[11px] uppercase tracking-wider text-white shadow-xs backdrop-blur-xs">
